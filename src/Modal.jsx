...
const Modal = ({ showModal, handleCloseModal, handleLogin }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white p-6 md:p-8 rounded-lg w-11/12 sm:w-4/5 md:w-3/5 lg:w-2/5 xl:w-1/3 max-w-md text-center">
        <h2 className="text-lg mb-4">Чтобы смотреть видео, сначала нужно войти через Instagram</h2>
        <div className="mt-4">
